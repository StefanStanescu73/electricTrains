...
function productCounter() {
    ...
    document.getElementById("productsInTheCart1").innerHTML = " Coș " + "[" + productsCounter + "]";
...
function deleteItem(element) {
    ...
    let result = confirm("Ești sigur/ă că vrei să ștergi produsul din coșul de cumpărături?");
    if (result === true) {
